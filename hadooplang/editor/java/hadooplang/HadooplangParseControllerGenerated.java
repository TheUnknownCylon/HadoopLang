...
public class HadooplangParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Hadooplang");
  ...
  { 
    HadooplangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = HadooplangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = HadooplangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(HadooplangParseControllerGenerated.class);
    }
  ...
  { 
    return HadooplangParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
